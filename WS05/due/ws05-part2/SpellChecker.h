...
namespace sdds {
	...
	public:
		//need to have defualt constructor
		SpellChecker() {} 
		SpellChecker(const char* filename);
		void operator()(std::string& text) const;
	};

	//helper function to eliminate the whitespace before the first non-space character and behind the last non-space character 
